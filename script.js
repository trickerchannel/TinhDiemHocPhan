            ...
            const createComponentRow = (name = '', weight = '', score = '', isFinal = false) => {
                ...
                row.innerHTML = `
                    ...
                    <div class="col-span-2">
                        <input type="number" class="form-input w-full bg-slate-100 border-transparent rounded-md text-center focus:ring-2 focus:ring-blue-500 focus:bg-white focus:border-blue-500" placeholder="%" min="0" max="100" step="1" value="${weight}">
                    </div>
                    <div class="col-span-2">
                        <input type="number" class="form-input w-full bg-slate-100 border-transparent rounded-md text-center focus:ring-2 focus:ring-blue-500 focus:bg-white focus:border-blue-500" placeholder="Điểm" min="0" max="10" step="0.1" value="${score}">
                    </div>
